...
function newLevel(){
	...
	var response=android.net.http.AndroidHttpClient.newInstance("Online()").execute(new org.apache.http.client.methods.HttpGet("https://raw.githubusercontent.com/wilco375/Minecraft-PE-Mod-Scripts/master/Portable_Structures_Mod_Update_V1.0.txt")).getEntity().writeTo(out);
	out.close();
