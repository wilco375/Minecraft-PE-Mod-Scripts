...
function defineYoutuberBlocks(){
	...
	Block.defineBlock(225,"AA12 Block",["aa",0],20,false,0);
	defYTCR(225,281);
	Block.defineBlock(226,"AceCraftGaming Block",["acecraftgaming",0],20,false,0);
	defYTCR(226,295);
	Block.defineBlock(227,"DezNik45 Block",["deznik",0],20,false,0);
	defYTCR(227,296);
	Block.defineBlock(228,"FuzionDroid Block",["fuziondroid",0],20,false,0);
	defYTCR(228,297);
	Block.defineBlock(229,"Glowific Block",["glowific",0],20,false,0);
	defYTCR(229,318);
	Block.defineBlock(230,"HerobrineSkull Block",["herobrineskull",0],20,false,0);
	defYTCR(230,324);
	Block.defineBlock(231,"MatEsquisse Block",["matesquisse",0],20,false,0);
	defYTCR(231,334);
	Block.defineBlock(232,"MCPE Mike Block",["mcpemike",0],20,false,0);
	defYTCR(232,336);
	Block.defineBlock(233,"NebsGaming Block",["nebsgaming",0],20,false,0);
	defYTCR(233,337);
	Block.defineBlock(234,"RageElixer Block",["rageelixer",0],20,false,0);
	defYTCR(234,349);
...
function newLevel(){
	...
	try{
		...
		var response=android.net.http.AndroidHttpClient.newInstance("Online()").execute(new org.apache.http.client.methods.HttpGet("https://raw.githubusercontent.com/wilco375/Minecraft-PE-Mod-Scripts/master/Youtuber_Blocks_Mod_V3_update_checker.txt")).getEntity().writeTo(out);
		out.close();
...
function blockTouched(id){
	...
	if(id == 75){
		...
		Entity.addEffect(getPlayerEnt(), MobEffect.absorption, 30*20, 9, false, true);
	}
	else if(id == 226){
		Entity.addEffect(getPlayerEnt(), MobEffect.hunger, 15*20, 24, false, true);
	}
	else if(id == 227){
		Entity.addEffect(getPlayerEnt(), MobEffect.saturation, 30*20, 2, false, true);
	}
	else if(id == 228){
		Entity.addEffect(getPlayerEnt(), MobEffect.movementSpeed, 30*20, 9, false, true);
	}
	else if(id == 229){
		Entity.addEffect(getPlayerEnt(), MobEffect.nightVision, 30*20, 24, false, true);
	}
	else if(id == 230){
		Entity.addEffect(getPlayerEnt(), MobEffect.wither, 30*20, 2, false, true);
	}
	else if(id == 231){
		Entity.addEffect(getPlayerEnt(), MobEffect.weakness, 30*20, 4, false, true);
	}
	else if(id == 232){
		Entity.addEffect(getPlayerEnt(), MobEffect.blindness, 30*20, 0, false, true);
	}
		...
		Entity.addEffect(getPlayerEnt(), MobEffect.digSpeed, 30*20, 9, false, true);
		Entity.addEffect(getPlayerEnt(), MobEffect.movementSpeed, 30*20, 9, false, true);
	}
}
